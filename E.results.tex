...
\begin{figure*}
    \centering
    \includegraphics[scale=0.8]{images/conditions.pdf}
...
The factors of the library itself help inform the process, as depicted in Figure~\ref{fig:framework}. We identified four categories of \code{factors}: \code{software factors}, \code{commercial factors}, \code{maintenance factors}, and \code{external factors}. Under these we found 28 concepts, whose relation to the categories is shown in Figure~4 in the Appendix.
