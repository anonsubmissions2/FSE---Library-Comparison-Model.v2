...
\newcommand{\td}[1]{\textcolor{black}{(#1)}}
...
\newcommand\actor[1]{\textbf{Actor:}  #1\\} 
...
\newcommand\steps[1]{\\\textbf{Steps:} #1}
\newcommand\consequence[1]{\\\textbf{Consequence:} #1}
\newcommand\example[2]{\\\textbf{Example Trace:} \qqi{#1}{#2}}
%#\newcommand\example[2]{\hline\\\textbf{Example Data:} \qqi{#1}{#2}}
%\newcommand\example[2]{\vspace*{.1em}\\\textbf{Example Trace:} \qqi{#1}{#2}}
...
\newcommand{\principle}[0]{\textcolor{black}{decision patterns}}

\newcommand{\model}[0]{\textcolor{black}{library adoption model}}
% \newcommand{\model}[0]{\textcolor{black}{library consumer behavior model}}